...
# - descrivi_veicolo(self): 
#       metodo che sovrascrive quello della classe base per includere anche 

# il - numero di porte nella descrizione, nel formato "Marca: [marca], Modello: [modello], Anno: [anno], Numero di porte: [numero_porte]".
