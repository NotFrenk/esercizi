...
# L'operazione può procedere solo se la condizione A è vera o se entrambe le condizioni B e C 
# sono vere. La funzione deve ritornare "Operazione permessa" oppure "Operazione negata"
