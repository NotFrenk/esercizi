...
#     che restituisca la codifica di un singolo carattere c da concatenare agli altri per costruire il messaggio codificato 
...
#     Suggerimento: si potrebbe definire un metodo privato combinazione(testo) che esegue la combinazione del testo e ritorni il testo cifrato
#     da usare nel metodo codifica(testoInChiaro).


# Si scriva il metodo decodifica(testoCodificato) per ognuna delle classi CifrarioAScorrimento e CifrarioACombinazione.

#     Suggerimento: definire il metodo privato decodifica_carattere() 
#     per la classe CifrarioAScorrimento che compie un'azione inversa al metodo sposta_carattere().

#     Suggerimento: definire il metodo privato decodifica_combinazione() 
#     per la classe CifrarioACombinazione che compie un'azione inversa al metodo combinazione().
